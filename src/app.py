...
if uploaded_file is not None:
    ...
    # ONLY PREVIEW FIRST FEW SECONDS

    max_samples = min(len(full_data), sr * duration)
    ...
    info_col3.write(
        f"**Channels:** {full_data.shape[1] if full_data.ndim > 1 else 1}"
    )
    ...
    save_audio(sf_path, original_preview, preview_sr)
    ...
    if st.button("Run Compression", type="primary"):
        ...
        # DOWNLOAD FULL RECONSTRUCTED AUDIO
